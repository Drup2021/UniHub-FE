...
const MapSearch = () => {
  ...
  const locations = {
    ...
    Gymnasium: [22.55549, 88.303426],
    "Science and Technology Building": [22.556, 88.3073],
  ...
  useEffect(() => {
    ...
    const campusBounds = L.latLngBounds(
      L.latLng(22.551, 88.303),
      L.latLng(22.56, 88.311)
    );
  ...
  const showSuggestions = (value, type) => {
    ...
    type === "from" ? setFromSuggestions(filtered) : setSuggestions(filtered);
  };
  ...
  return (
    <div style={{ height: "100vh", position: "relative" }}>
      ...
      <div
        id="map"
        ref={mapRef}
        style={{ height: "100vh", zIndex: 1, position: "relative" }}
      ></div>
      ...
      >
        ...
        <div id="instructions" style={{ fontSize: "14px" }}></div>
      </div>
    </div>
  );
};
